...
from src.models import (
    FeedbackItem, SentimentAnalysis, TopicAnalysis, InsightAnalysis,
...
class TestLLMInsightService:
    ...
    def test_init_anthropic_provider(self):
        ...
        with patch('src.insights.llm_service.settings') as mock_settings:
            ...
            with patch('src.insights.llm_service.anthropic.Anthropic') as mock_anthropic:
    ...
    def test_analyze_sentiment_api_error(self):
        ...
        with patch.object(self.service, '_call_llm', side_effect=Exception("API Error")):
            result = self.service._analyze_sentiment("Test content")
    ...
    def test_analyze_single_item_success(self, sample_feedback_item):
        ...
        with patch.object(self.service, '_analyze_sentiment', return_value=mock_sentiment):
            with patch.object(self.service, '_analyze_topics', return_value=mock_topics):
    ...
    def test_analyze_single_item_error(self, sample_feedback_item):
        ...
        with patch.object(self.service, '_prepare_content', side_effect=Exception("Error")):
            result = self.service.analyze_single_item(sample_feedback_item)
    ...
    def test_analyze_feedback_items_success(self, sample_feedback_items):
        ...
        with patch.object(self.service, 'analyze_single_item', return_value=mock_analysis):
    ...
    def test_analyze_feedback_items_with_failures(self, sample_feedback_items):
        ...
        with patch.object(self.service, 'analyze_single_item', side_effect=mock_analyze):
            results = self.service.analyze_feedback_items(sample_feedback_items)
    ...
    def test_test_connection_success(self):
        ...
        with patch.object(self.service, '_call_llm', return_value="Success! I can see this message."):
            assert self.service.test_connection() is True
    
    def test_test_connection_failure(self):
        """Test failed connection test."""
        with patch.object(self.service, '_call_llm', side_effect=Exception("Connection failed")):
    ...
    def test_test_connection_no_success_word(self):
        ...
        with patch.object(self.service, '_call_llm', return_value="This is a different response"):
            assert self.service.test_connection() is False