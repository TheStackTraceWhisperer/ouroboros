...
class TestGoalGenerationService:
        ...
        return [
            InsightAnalysis(
                ...
                topic_analysis=TopicAnalysis(
                    topics=[TopicTag.BUG], confidence=0.95, reasoning="Clear bug report"
                ),
            ),
            InsightAnalysis(
    ...
    def test_calculate_priority_medium_severity(self, sample_trend):
        ...
        sample_trend.trend_type = (
            TrendType.TOPIC_CLUSTER
        )  # Non-sentiment shift to avoid boost
    ...
    def test_filter_relevant_feedback(
        self, sample_trend, sample_feedback, sample_analyses
    ):
    ...
    def test_filter_relevant_feedback_sentiment_shift(
        self, sample_feedback, sample_analyses
    ):
    ...
    def test_generate_goal_with_llm_title_too_short(
        self, sample_trend, sample_feedback
    ):
    ...
    def test_generate_single_goal_success(
        self, sample_trend, sample_feedback, sample_analyses
    ):
        ...
        goal = self.service.generate_single_goal(
            sample_trend, sample_feedback, sample_analyses
        )
    ...
    def test_generate_goals_from_trends_success(
        self, sample_trend, sample_feedback, sample_analyses
    ):
        ...
        goals = self.service.generate_goals_from_trends(
            trends, sample_feedback, sample_analyses
        )
    ...
    def test_generate_goals_from_trends_with_failures(
        self, sample_feedback, sample_analyses
    ):
